					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="job-detail-wrapper">
								...
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"> Login as employee to apply</button>';
								}
								}
								...
								print '<button class="btn btn-primary disabled btn-hidden btn-lg collapsed"></i> Login to apply this job</button>';
								}
