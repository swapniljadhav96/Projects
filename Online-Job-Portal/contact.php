			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/55.png" alt="Logo" /></a>
						</div>
					</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<?php include 'constants/check_reply.php'; ?>
							...
							<form class="contact-form-wrapper" data-toggle="validator" method="POST" autocomplete="off">
								...
								<div class="row">
									...
									<div class="col-sm-12">
										...
										<div class="form-group">
											...
											<textarea id="inputMessage" name="message" class="form-control" rows="8" data-error="Your message is required and must not less than 50 characters"></textarea>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-sm-12 text-right">
										<button type="submit" onclick="alert('Your message has been sent.')" class="btn btn-primary mt-5">Send Message</button>
									</div>
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										Sanjivani, <br/> Kopargaon<br>
								</li>
								<li>
										<h5>Email</h5>jobify@gmail.com
								</li>
								<li>
										<h5>Phone Number</h5>1234567890
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Jobify</h5>
											<p>Jobify is a job portal, online job management system.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Sanjivani, Kopargaon</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Jobify</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li>Developed by Group id 15</li>
								</ul>
